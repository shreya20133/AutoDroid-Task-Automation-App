...
public class AqiMonitor extends AppCompatActivity {
    ...
    private final String API_KEY ="57982133-689b-483d-88d6-775026357106";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aqi_monitor);
        helpImageView=findViewById(R.id.helpAQI);
        featureInfoDriveCardView=findViewById(R.id.featureinfo_AQI);
        ...
        searchIconState = findViewById(R.id.state_search_icon);
        searchIconCity = findViewById(R.id.city_search_icon);

        countrySearch = findViewById(R.id.country_search);
        countrySearch.setHint("Search your Country here");

        stateSearch = findViewById(R.id.state_search);
        ...
        ArrayAdapter<String> adapterCountry = new ArrayAdapter<>(this, android.R.layout.simple_dropdown_item_1line, countryList);
        ...
        countrySearch.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ArrayAdapter<String> adapterState = new ArrayAdapter<>(getApplicationContext(), android.R.layout.simple_dropdown_item_1line, stateList);
        ...
        stateSearch.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ArrayAdapter<String> adapterCity = new ArrayAdapter<>(getApplicationContext(), android.R.layout.simple_dropdown_item_1line, cityList);
        ...
        nearestData = findViewById(R.id.nearest_data_button);
        nearestData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentNearest = new Intent(getApplicationContext(), NearestCityInfoActivity.class);
